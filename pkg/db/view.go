...
func (s *view) GenerateDdlSingle(schema string, view string) <-chan *Migration {
	return streamMigration(s.db, fmt.Sprintf(QUERY_VIEW, schema, view), func(rows *sql.Rows) (*Migration, error) {

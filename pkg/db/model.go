...
const (
	...
	ALTER_COLUMN_TYPE = "ALTER COLUMN %s TYPE %s;\n"

	ALTER_COLUMN_SET_NOT_NULL = "ALTER COLUMN %s SET NOT NULL;\n"

	ALTER_COLUMN_DROP_NOT_NULL = "ALTER COLUMN %s DROP NOT NULL;\n"

	ALTER_COLUMN_SET_DEFAULT = "ALTER COLUMN %s SET DEFAULT %s;\n"

	ALTER_COLUMN_DROP_DEFAULT = "ALTER COLUMN %s DROP DEFAULT;\n"
